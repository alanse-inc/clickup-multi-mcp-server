...
export class TaskServiceCore extends BaseClickUpService {
   ...
   */
  async mergeTask(taskId: string, data: MergeTaskData): Promise<ClickUpTask> {
    try {
      ...
      return await this.makeRequest(async () => {
        const response = await this.client.post<ClickUpTask>(path, data);
   ...
   */
  async getTimeInStatus(taskId: string): Promise<TimeInStatusData> {
    try {
      ...
      return await this.makeRequest(async () => {
        const response = await this.client.get<TimeInStatusData>(path);
        return response.data;
      });
    } catch (error) {
   ...
   */
  async getBulkTimeInStatus(taskIds: string[]): Promise<BulkTimeInStatusResponse> {
    try {
      ...
      return await this.makeRequest(async () => {
        const response = await this.client.get<BulkTimeInStatusResponse>(path);
        return response.data;
      });
    } catch (error) {
   ...
   * @returns The updated task
   */
  async addTaskToList(listId: string, taskId: string): Promise<ClickUpTask> {
    try {
      ...
      return await this.makeRequest(async () => {
        const response = await this.client.post<ClickUpTask>(path);
        return response.data;
      });
    } catch (error) {
   ...
   */
  async removeTaskFromList(listId: string, taskId: string): Promise<void> {
    try {
