...
/**
 * Data for merging tasks
 */
export interface MergeTaskData {
  merge_from_id: string;
}

/**
 * Time in status data for a single task
 */
...
/**
 * Response for bulk time in status request
 */
export interface BulkTimeInStatusResponse {
  data: {
    [taskId: string]: TimeInStatusData;
  };
}
...
/**
 * Key Result (Target) object as returned by the ClickUp API
 */
...
/**
 * Goal object as returned by the ClickUp API
 */
...
/**
 * Response when retrieving goals
 */
...
/**
 * Response when retrieving a single goal
 */
...
/**
 * Key Result type options
 */
export type KeyResultType = 'number' | 'currency' | 'boolean' | 'percentage' | 'automatic';

/**
 * Data for creating a key result
 */
...
/**
 * Data for updating a key result
 */
...
/**
 * Response when creating/updating a key result
 */
export interface KeyResultResponse {
  key_result: ClickUpKeyResult;
}
...
/**
 * Space features configuration for create/update
 */
...
/**
 * Response for task link operations
 */
